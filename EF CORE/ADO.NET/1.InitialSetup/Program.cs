...
namespace InitialSetup
{
    class Program
    {
        private static string connectionStr = "Server =.;Integrated Security = true;Database = {0}";
        static void Main(string[] args)
        {
            var connection = new SqlConnection(string.Format(connectionStr, "master"));
            using (connection)
            {
                connection.Open();
            ...
            connection = new SqlConnection(string.Format(connectionStr, "MinionsDB"));
            using (connection)
            {
                connection.Open();
...
('Bob', 42, 3),('Kevin', 1, 1),('Bob ', 32, 6),('Simon', 45, 3),('Cathleen', 11, 2),('Carry ', 50, 10),('Becky', 125, 5),('Mars', 21, 1),('Misho', 5, 10),('Zoe', 125, 5),('Json', 21, 1)
            ...
            (4,2),(1,1),(5,7),(3,5),(2,6),(11,5),(8,4),(9,7),(7,1),(1,3),(7,3),(5,3),(4,3),(1,2),(2,1),(2,7)",connection);
